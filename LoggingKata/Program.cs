    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < locations.Length; i++)
            {
                ...
                var corA = new GeoCoordinate(); //create geolocation object
                ...
                for (int j = 0; j < locations.Length; j++)
                {
                    ...
                    var corB = new GeoCoordinate(); //create geolocation object
                    corB.Latitude = locB.Location.Latitude;
                    corB.Longitude = locB.Location.Longitude;

                    // TODO: Now, still being inside the scope of the second for loop, compare the two locations using `.GetDistanceTo()` method, (this is from the GeoCoordinate class) which returns a double.
                    ...
                    {
                        //update the distance to new distance
                        distance = corA.GetDistanceTo(corB);
                        //update both locA and locB
                        tacoBell1 = locA;
                        tacoBell2 = locB;
                    }
                } //end inner loop
